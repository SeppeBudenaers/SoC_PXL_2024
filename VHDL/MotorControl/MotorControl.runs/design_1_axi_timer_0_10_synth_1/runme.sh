...
HD_PWD='C:/XilinxDev/SOC/Seppe-en-Kobe/VHDL/MotorControl/MotorControl.runs/design_1_axi_timer_0_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_timer_0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_timer_0_10.tcl
