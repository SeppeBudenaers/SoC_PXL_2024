...
#define AXI_TIMER_PERIOD_US 100

//The duration of PWM high level (in microseconds)

#define AXI_TIMER_PWM_HIGH_TIME_US 60
...
// Timing microseconds or nanoseconds
...
#endif
    XTmrCtr_PwmDisable(&xTmrCtr_Inst);
    XTmrCtr_PwmConfigure(&xTmrCtr_Inst, xTmr_US_To_NS(AXI_TIMER_PERIOD_US), xTmr_US_To_NS(50));
    XTmrCtr_PwmEnable(&xTmrCtr_Inst);
    while (1);
