...
HD_PWD='C:/XilinxDev/SOC/SeppeEnKobe/VHDL/MotorControl/MotorControl.runs/design_1_Speedsensor_0_12_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Speedsensor_0_12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Speedsensor_0_12.tcl
