...
HD_PWD='C:/02_PXL/SoC_PXL_2024/hardware_block/Speed_Sensor/Speed_Sensor.runs/design_1_SpeedCounter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SpeedCounter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SpeedCounter_0_0.tcl
