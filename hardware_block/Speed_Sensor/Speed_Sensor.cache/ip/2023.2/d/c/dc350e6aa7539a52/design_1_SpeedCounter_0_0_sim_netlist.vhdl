...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SpeedCounter is
  ...
  signal \speed_sig[31]_i_6_n_0\ : STD_LOGIC;
  signal \speed_sig[31]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \speed_sig[31]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \speed_sig[31]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \speed_sig[31]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \speed_sig[31]_i_7\ : label is "soft_lutpair1";
...
\speed_sig[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFEAAAAAAAAA"
    )
        port map (
      I0 => \speed_sig[31]_i_2_n_0\,
      I1 => \speed_sig[31]_i_3_n_0\,
      I2 => \speed_sig[31]_i_4_n_0\,
      I3 => \speed_sig[31]_i_5_n_0\,
      I4 => \speed_sig[31]_i_6_n_0\,
      I5 => \speed_sig[31]_i_7_n_0\,
      O => \speed_sig[31]_i_1_n_0\
    );
\speed_sig[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\speed_sig[31]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\speed_sig[31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFE000"
    )
        port map (
...
\speed_sig[31]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEEE"
    )
        port map (
      ...
      I2 => timer_sig_reg(13),
      I3 => timer_sig_reg(15),
      O => \speed_sig[31]_i_6_n_0\
    );
\speed_sig[31]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
