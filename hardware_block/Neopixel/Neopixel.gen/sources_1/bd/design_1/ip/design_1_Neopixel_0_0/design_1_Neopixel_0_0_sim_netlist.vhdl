...
--               c:/02_PXL/2023/Digitale_Systemen_PXL_2023/VHDL/Labo/Oef_5_12/Oef_5_12.gen/sources_1/bd/design_1/ip/design_1_Neopixel_0_0/design_1_Neopixel_0_0_sim_netlist.vhdl
...
entity design_1_Neopixel_0_0_Neopixel is
  port (
    d_out : out STD_LOGIC;
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_Neopixel_0_0_Neopixel : entity is "Neopixel";
end design_1_Neopixel_0_0_Neopixel;

architecture STRUCTURE of design_1_Neopixel_0_0_Neopixel is
  ...
  signal \comb_proc.delay_high_cntr[2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \comb_proc.delay_high_cntr[3]_i_1_n_0\ : STD_LOGIC;
  signal \comb_proc.delay_high_cntr[4]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \comb_proc.delay_high_cntr[5]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \comb_proc.delay_low_cntr[12]_i_8_n_0\ : STD_LOGIC;
  ...
  signal \comb_proc.delay_low_cntr_reg[12]_i_4_n_1\ : STD_LOGIC;
  signal \comb_proc.delay_low_cntr_reg[12]_i_4_n_2\ : STD_LOGIC;
  signal \comb_proc.delay_low_cntr_reg[12]_i_4_n_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \comb_proc.delay_high_cntr[5]_i_6\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \comb_proc.delay_high_cntr[5]_i_7\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \comb_proc.delay_high_cntr[5]_i_8\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \comb_proc.delay_high_cntr[5]_i_9\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[10]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[12]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[12]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[5]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \comb_proc.delay_low_cntr[9]_i_1\ : label is "soft_lutpair4";
  attribute ADDER_THRESHOLD of \comb_proc.delay_low_cntr_reg[12]_i_4\ : label is 35;
...
\comb_proc.delay_high_cntr[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => PS(0),
      O => \comb_proc.delay_high_cntr[2]_i_1_n_0\
    );
...
\comb_proc.delay_high_cntr[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      O => \comb_proc.delay_high_cntr[3]_i_1_n_0\
    );
\comb_proc.delay_high_cntr[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => PS(0),
      O => \comb_proc.delay_high_cntr[4]_i_1_n_0\
    );
...
\comb_proc.delay_high_cntr[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \comb_proc.delay_high_cntr_reg[5]_i_4_n_4\,
      I4 => \comb_proc.delay_high_cntr[5]_i_5_n_0\,
      O => \comb_proc.delay_high_cntr[5]_i_2_n_0\
    );
...
\comb_proc.delay_high_cntr_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \comb_proc.delay_high_cntr[5]_i_1_n_0\,
      D => \comb_proc.delay_high_cntr[2]_i_1_n_0\,
      Q => delay_high_cntr(2),
      R => '0'
    );
...
\comb_proc.delay_high_cntr_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \comb_proc.delay_high_cntr[5]_i_1_n_0\,
      D => \comb_proc.delay_high_cntr[3]_i_1_n_0\,
      Q => delay_high_cntr(3),
      R => '0'
    );
\comb_proc.delay_high_cntr_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \comb_proc.delay_high_cntr[5]_i_1_n_0\,
      D => \comb_proc.delay_high_cntr[4]_i_1_n_0\,
      Q => delay_high_cntr(4),
      R => '0'
    );
\comb_proc.delay_high_cntr_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \comb_proc.delay_high_cntr[5]_i_1_n_0\,
      D => \comb_proc.delay_high_cntr[5]_i_2_n_0\,
      Q => delay_high_cntr(5),
      R => '0'
    );
...
\comb_proc.delay_low_cntr[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
      ...
      I1 => PS(1),
      I2 => PS(0),
      I3 => delay_low_cntr0(10),
      O => p_1_in(10)
    );
\comb_proc.delay_low_cntr[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
...
\comb_proc.delay_low_cntr[12]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \NS1_carry__2_n_0\,
      I4 => PS(0),
      I5 => \comb_proc.delay_low_cntr[12]_i_3_n_0\,
      O => \comb_proc.delay_low_cntr[12]_i_1_n_0\
    );
\comb_proc.delay_low_cntr[12]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
      ...
      I1 => PS(1),
      I2 => PS(0),
      I3 => delay_low_cntr0(12),
      O => p_1_in(12)
    );
\comb_proc.delay_low_cntr[12]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\comb_proc.delay_low_cntr[12]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => delay_low_cntr(9),
      O => \comb_proc.delay_low_cntr[12]_i_8_n_0\
    );
...
\comb_proc.delay_low_cntr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \comb_proc.delay_low_cntr[5]_i_2_n_0\,
...
\comb_proc.delay_low_cntr[31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
        ...
        port map (
      I0 => \comb_proc.delay_low_cntr[12]_i_3_n_0\,
      I1 => PS(0),
      I2 => PS(2),
      I3 => PS(1),
...
\comb_proc.delay_low_cntr[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CFC0AAAA0000AAAA"
    )
        port map (
      I0 => delay_low_cntr0(4),
      I1 => \comb_proc.delay_high_cntr[5]_i_3_n_0\,
      I2 => \comb_proc.delay_high_cntr_reg[5]_i_4_n_4\,
      I3 => \comb_proc.delay_high_cntr[5]_i_5_n_0\,
      I4 => \comb_proc.delay_low_cntr[5]_i_2_n_0\,
      I5 => \NS1__15_carry__2_n_0\,
      O => p_1_in(4)
    );
...
\comb_proc.delay_low_cntr[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\comb_proc.delay_low_cntr[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
...
\comb_proc.delay_low_cntr[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
      ...
      I1 => PS(1),
      I2 => PS(0),
      I3 => delay_low_cntr0(8),
      O => p_1_in(8)
    );
\comb_proc.delay_low_cntr[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
...
\comb_proc.delay_low_cntr_reg[12]_i_4\: unisim.vcomponents.CARRY4
     port map (
      CI => \comb_proc.delay_low_cntr_reg[7]_i_1_n_0\,
      CO(3) => \comb_proc.delay_low_cntr_reg[12]_i_4_n_0\,
      CO(2) => \comb_proc.delay_low_cntr_reg[12]_i_4_n_1\,
      CO(1) => \comb_proc.delay_low_cntr_reg[12]_i_4_n_2\,
      CO(0) => \comb_proc.delay_low_cntr_reg[12]_i_4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => delay_low_cntr(12 downto 9),
      O(3 downto 0) => delay_low_cntr0(12 downto 9),
      S(3) => \comb_proc.delay_low_cntr[12]_i_5_n_0\,
      S(2) => \comb_proc.delay_low_cntr[12]_i_6_n_0\,
      S(1) => \comb_proc.delay_low_cntr[12]_i_7_n_0\,
      S(0) => \comb_proc.delay_low_cntr[12]_i_8_n_0\
    );
...
\comb_proc.delay_low_cntr_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \comb_proc.delay_low_cntr_reg[12]_i_4_n_0\,
...
entity design_1_Neopixel_0_0 is
  ...
  attribute NotValidForBitStream of design_1_Neopixel_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_Neopixel_0_0 : entity is "design_1_Neopixel_0_0,Neopixel,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_Neopixel_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_Neopixel_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_Neopixel_0_0 : entity is "Neopixel,Vivado 2023.2";
end design_1_Neopixel_0_0;

architecture STRUCTURE of design_1_Neopixel_0_0 is
...
begin
U0: entity work.design_1_Neopixel_0_0_Neopixel
     port map (
      clk => clk,
      d_out => d_out,
