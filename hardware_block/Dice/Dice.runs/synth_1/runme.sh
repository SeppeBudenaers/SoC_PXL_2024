...
HD_PWD='C:/02_PXL/2023/Digitale_Systemen_PXL_2023/VHDL/Labo/Oef_4_3/Oef_4_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dice.tcl
