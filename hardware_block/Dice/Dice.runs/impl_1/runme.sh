...
HD_PWD='C:/02_PXL/2023/Digitale_Systemen_PXL_2023/VHDL/Labo/Oef_4_3/Oef_4_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dice.tcl -notrace
